...
void loop() {
  ...
  //Abrimos un if para comprobar si la distancia es mayor 100 cm
  if(distancia>100) {
    moverMotores(255, 1, 0); //Los motores giran hacia la derecha y la izquierda
    
    //Apartado de LEDs
    digitalWrite(LED_VERDE, LOW);
    digitalWrite(LED_BLANCO, HIGH); //Se enciende Led blanco
    digitalWrite(LED_ROJO, LOW);
  } 
  
  //Abrimos un else if para comprobar si la distancia está entre 50 y 100 cm
  ...
  //ADetecta si la distancia es menor a 50 cm
  else {
